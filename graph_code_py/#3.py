...
file = open('/home/ivankhripunov/CLionProjects/container_lab/cmake-build-debug/#3.txt', 'r')
...
ax.plot(size, approx_subvector, "g--", label="Аппроксимация y = 2.1 + 1850")
ax.set_title("Удаление из произвольного места контейнера")
...
ax2.plot(size, approx_vector, "r--", label="Аппроксимация y = 3.5e-2 * x + 1.18e3")
ax2.set_title("Удаление из произвольного места контейнера (только vector)")
