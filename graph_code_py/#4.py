...
file = open('/home/ivankhripunov/CLionProjects/container_lab/cmake-build-debug/#4.txt', 'r')
...
ax.plot(size, approx_subvector, "g--", label="Аппроксимация y = 1112")
...
ax2.plot(size, approx_vector, "r--", label="Аппроксимация y = 1110")
ax2.set_title("Random access (только vector)")
